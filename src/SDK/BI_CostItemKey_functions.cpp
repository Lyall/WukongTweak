...
#include "BI_CostItemKey_classes.hpp"
#include "BI_CostItemKey_parameters.hpp"
...
void UBI_CostItemKey_C::InitTxt(class UTextBlock* TxtObj, const struct FAnchors& TxtAnchors, const struct FVector2D& TxtAlignment, const struct FVector2D& TxtPos, const struct FSlateColor& TxtColor, const struct FSlateFontInfo& TxtFont, const struct FVector2D& TxtShadowOffset, const struct FLinearColor& TxtShadowColor, ETextJustify TxtJustification)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BI_CostItemKey_C", "InitTxt");

	Params::BI_CostItemKey_C_InitTxt Parms{};
...
void UBI_CostItemKey_C::InitUI(class UImage* Obj, const struct FSlateBrush& Brush, const struct FVector2D& Size, const struct FVector2D& Pos)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BI_CostItemKey_C", "InitUI");

	Params::BI_CostItemKey_C_InitUI Parms{};
