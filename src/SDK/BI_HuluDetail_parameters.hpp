...
static_assert(alignof(BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail) == 0x000008, "Wrong alignment on BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail");
static_assert(sizeof(BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail) == 0x000038, "Wrong size on BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail");
static_assert(offsetof(BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail, EntryPoint) == 0x000000, "Member 'BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail::EntryPoint' has a wrong offset!");
static_assert(offsetof(BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail, K2Node_Event_IsDesignTime) == 0x000004, "Member 'BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail::K2Node_Event_IsDesignTime' has a wrong offset!");
static_assert(offsetof(BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail, K2Node_CustomEvent_NGForgeSpark_Top_1) == 0x000008, "Member 'BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail::K2Node_CustomEvent_NGForgeSpark_Top_1' has a wrong offset!");
static_assert(offsetof(BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail, K2Node_CustomEvent_NGForgeSpark_Top) == 0x000010, "Member 'BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail::K2Node_CustomEvent_NGForgeSpark_Top' has a wrong offset!");
static_assert(offsetof(BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail, K2Node_CustomEvent_NGForgeSpark_Left_1) == 0x000018, "Member 'BI_HuluDetail_C_ExecuteUbergraph_BI_HuluDetail::K2Node_CustomEvent_NGForgeSpark_Left_1' has a wrong offset!");
